...
const Navbar = () => {
    ...
    const encodedMessage = "Hello! 👋 I'm excited that you're interested in my beautiful bracelets! 🧡✨ How can I assist you today? Feel free to ask about our designs, customization options, pricing, or anything else. I'm here to help! 😊"
  return (
